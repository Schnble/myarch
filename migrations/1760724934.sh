...
cp -r $MYARCH_PATH/config/myarch/* $HOME/.config/myarch/

echo "Add packages for updated myarch-capture-screenshot"
myarch-pkg-add grim slurp

echo "Add nfs support by default to Nautilus"
myarch-pkg-add gvfs-nfs

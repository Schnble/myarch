...
o.bind("SUPER + ALT + RETURN", "Tmux", { myarch = "terminal-tmux" })
...
o.bind("SUPER + SHIFT + M", "Music", { myarch = "or-focus spotify" })
...
-- o.bind("SUPER + SPACE", "Myarch menu", "myarch-menu")

-- Logitech MX Keys examples:
-- o.bind("SUPER + SHIFT + S", nil, "myarch-capture-screenshot")
-- o.bind("SUPER + H", nil, "voxtype record toggle")
-- o.bind("SUPER + PERIOD", nil, { myarch = "walker -m symbols" })

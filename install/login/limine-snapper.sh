...
EOF
  ...
  sudo cp $MYARCH_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $MYARCH_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $MYARCH_PATH/default/snapper/root /etc/snapper/configs/root

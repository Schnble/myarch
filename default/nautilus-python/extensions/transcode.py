...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("myarch-launch-floating-terminal-with-presentation")
        binary = shutil.which("myarch-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="MyarchTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("myarch-launch-floating-terminal-with-presentation")
            and shutil.which("myarch-transcode")
        )

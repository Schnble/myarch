...
o.bind("CTRL + ALT + DELETE", "Close all windows", "myarch-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "myarch-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "myarch-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "myarch-hyprland-monitor-scaling-cycle")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "myarch-hyprland-monitor-scaling-cycle --reverse")

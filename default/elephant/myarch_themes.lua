--
-- Dynamic Myarch Theme Menu for Elephant/Walker
--
Name = "myarchthemes"
NamePretty = "Myarch Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/myarch/themes"
  local myarch_path = os.getenv("MYARCH_PATH") or ""
  local default_theme_dir = myarch_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "myarch-theme-set " .. theme_name,
            },
          })
        end
      end
